...
export const OrderGuidePlan: FC = () => {
   return (
      <section className="max-w-screen-xl mx-auto px-4 md:px-8 py-20 bg-[url(src/assets/plan/mobile/bg-steps.png)] md:bg-[url(src/assets/plan/tablet/bg-steps.png)] lg:bg-[url(src/assets/plan/desktop/bg-steps.png)] m-25 rounded-xl">
         ...
         <div className="flex flex-col md:flex-row gap-12">
            <div>
               <p className="font-fraunces text-[#FDD6BA] font-extrabold text-4xl mb-4 text-6xl">01</p>
            ...
            <div>
               <p className="font-fraunces text-[#FDD6BA] font-extrabold text-4xl mb-4 text-6xl">02</p>
            ...
            <div>
               <p className="font-fraunces text-[#FDD6BA] font-extrabold text-4xl mb-4 text-6xl">03</p>
