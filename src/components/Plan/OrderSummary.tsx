...
export const OrderSummary: FC<OrderSummaryProps> = ({ preference, grind, kind, amount, delivery }) => {
    ...
    return (
        <div className="bg-[url(/assets/plan/mobile/bg-order-summary.png)] lg:bg-[url(/assets/plan/desktop/bg-order-summary.png)] rounded-xl h-auto flex flex-col justify-start gap-2 mt-4 ">
