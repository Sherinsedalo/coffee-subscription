...
export const Hero: FC = () => {
    ...
    return (
        <section className='relative bg-cover bg-center h-[600px] text-[#FEFCF7] rounded-xl mt-8 sm-h[500px] md:h-[550px] bg-[url(/assets/home/desktop/image-hero-coffeepress.jpg)] sm:bg-[url(/assets/home/mobile/image-hero-coffeepress.jpg)] md:bg-[url(/assets/home/tablet/image-hero-coffeepress.jpg)]'>
